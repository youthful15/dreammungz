...
export default function Modal({ isOpen, modalClose, children }: ModalProps) {
    ...
    >
      ...
      >
        <div
          ...
          ref={outModal}
        >
          <div className="relative bg-white rounded-lg w-[680px] h-[400px] text-left overflow-hidden shadow-xl transform transition-all sm:my-8 flex justify-center items-center">
