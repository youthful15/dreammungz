...
export default function OkToast({
  title,
  content,
}: {
  title: string
  ...
  return (
    <div
      className={`${toastCSS} absolute right-2 bg-green-500 shadow-lg mx-auto w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3`}
      id="static-example"
      role="alert"
      aria-live="assertive"
      aria-atomic="true"
